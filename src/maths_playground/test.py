...
from direct.stdpy.threading import Lock, Thread
...
class MyApp(ShowBase):
    ...
    def __init__(self):
        ...
        # global bonesJoint
        # global imus
        # modelCube = self.loader.loadModel("models/cube.egg")
        # modelBone = self.loader.loadModel("models/bone.egg")
        # for key in imus:
        ...
        modelCoord = self.loader.loadModel("models/coord.egg")
...
def printData(data):
    ...
    for name in data["rawQuats"]:
        print(
            ...
            % (
                name,
                data["rawQuats"][name].x,
                data["rawQuats"][name].y,
                data["rawQuats"][name].z,
                data["rawQuats"][name].w,
            )
        )
    print("\033[18;0H")
